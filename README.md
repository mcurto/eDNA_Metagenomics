# eDNA Metagenomics: Scripts and codes used in Curto, M., Veríssimo, A., Santos, C. D., Riccioni, G., Ribeiro, F., Jentoft, S., Alves, M. J., Gante, H. F. (in prep.) Improving whole biodiversity monitoring and discovery with environmental DNA metagenomics. 
